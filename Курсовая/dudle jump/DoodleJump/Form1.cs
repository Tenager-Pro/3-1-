...
namespace DoodleJump
{
    public partial class Form1 : Form
    {
        ...
        public Form1(Form2 f)
        {
            ...
            this.BackgroundImage = Properties.Resources.back;//установка фона
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            this.Height = 600;//Высота окна
            this.Width = 330;//ширина окна
        ...
        private void OnKeyboardPressed(object sender,KeyEventArgs e)//работа с клавиатурой
        {
            switch (e.KeyCode.ToString())
            {
                case "Right":
        ...
        public void FollowPlayer()//нахождение игрока
        {
        ...
        private void OnRepaint(object sender, PaintEventArgs e)//отрисовка
        {
